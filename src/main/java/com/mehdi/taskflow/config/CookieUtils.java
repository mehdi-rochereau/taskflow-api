 ...
 *
 * <p>Centralizes cookie management to avoid duplication between {@link
 * com.mehdi.taskflow.user.UserService} and {@link com.mehdi.taskflow.auth.RefreshTokenService}.
 *
 * <p>All cookies are configured with {@code HttpOnly} and {@code SameSite=Strict} to prevent XSS
 * token theft and CSRF attacks. The {@code Secure} flag is controlled by the {@code secure}
 * parameter and should be set to {@code true} in production (HTTPS).
 */
public final class CookieUtils {
    ...
    public static void clearCookie(
            HttpServletResponse response, String name, String path, boolean secure) {
        String cookieValue =
                name
                        + "="
                        + "; HttpOnly"
