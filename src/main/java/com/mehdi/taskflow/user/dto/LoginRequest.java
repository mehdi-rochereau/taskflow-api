 ...
 *
 * <p>Used as the request body for {@code POST /api/auth/login}. The {@code identifier} field
 * accepts either a username or an email address, supporting dual-identifier authentication.
 *
 ...
 *     jakarta.servlet.http.HttpServletResponse)
 */
@Schema(name = "LoginRequest", description = "Request body for authenticating an existing user")
public class LoginRequest {

    /** Username or email address used to identify the user. Must not be blank. */
    @Schema(
