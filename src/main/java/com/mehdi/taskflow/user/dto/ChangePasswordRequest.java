 ...
 *
 * <p>Used as the request body for {@code POST /api/users/me/password}. Both fields are required —
 * the current password is verified before the new password is applied.
 *
 * <p>The new password must meet the application's strength requirements: at least 8 characters, one
...
public class ChangePasswordRequest {
    ...
    /**
     * The user's current password. Verified against the stored BCrypt hash before applying the new
     * password.
     */
    @Schema(
            description =
                    "The user's current password. Used to verify identity before applying the change.",
