 ...
 *
 * <p>Returned by {@code GET /api/users/me} — exposes only non-sensitive fields. The password,
 * refresh tokens, and OAuth2 provider details are never included.
 *
 * <p>This class is immutable — all fields are final and set via the constructor.
 */
