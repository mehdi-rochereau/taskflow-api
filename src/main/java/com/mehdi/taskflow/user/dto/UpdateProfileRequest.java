 ...
 *
 * <p>Used as the request body for {@code PUT /api/users/me}.
 * Both fields are required — partial updates are not supported.
 * Uniqueness of username and email is enforced before persistence.</p>
 *
...
public class UpdateProfileRequest {
     ...
     * Must be between 3 and 50 characters, must not be blank,
     ...
     * Must be a valid email format, must not be blank,
     * and must be unique across all users.
     */
    @Schema(
