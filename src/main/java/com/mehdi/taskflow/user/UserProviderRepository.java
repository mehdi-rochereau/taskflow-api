 ...
 *
 * <p>Provides lookup methods for finding linked providers by provider type and provider-specific
 * identifier.
 */
@Repository
public interface UserProviderRepository extends JpaRepository<UserProvider, Long> {
    ...
    /**
     * Counts the number of providers linked to a user. Used to prevent unlinking the last remaining
     * provider.
     *
     * @param user the user account
