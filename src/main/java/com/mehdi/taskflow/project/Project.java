 ...
 *
 * <p>A project acts as a container for {@link Task} entities. Only the owner can create, update, or
 * delete tasks within the project.
 *
 * <p>The {@link #owner} association is loaded lazily to avoid unnecessary database queries when
 * only project metadata is needed.
 *
 * @see Task
 * @see User
 */
...
public class Project {
    ...
    /** The user who owns this project. Loaded lazily — only fetched when explicitly accessed. */
    ...
    /**
     * Timestamp of project creation. Set automatically on first persist. Cannot be updated after
     * creation.
     */
