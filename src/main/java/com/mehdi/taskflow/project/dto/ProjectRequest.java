 ...
 *
 * <ul>
 *   <li>{@code POST /api/projects} — create a new project
 *   <li>{@code PUT /api/projects/{id}} — update an existing project
 * </ul>
 *
 * @see com.mehdi.taskflow.project.ProjectController
 * @see com.mehdi.taskflow.project.ProjectService
 */
@Schema(name = "ProjectRequest", description = "Request body for creating or updating a project")
