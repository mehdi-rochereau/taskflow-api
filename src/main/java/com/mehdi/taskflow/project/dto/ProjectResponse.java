 ...
 *
 * <p>Wraps a {@link Project} entity and exposes only the fields relevant to the API consumer.
 * Sensitive or internal fields (such as the full owner entity) are excluded.
 *
 * <p>This class is immutable — all fields are final and set once at construction time. No setters
 * are provided.
 *
 * <p>Used as the response body for all project endpoints.
 *
...
public class ProjectResponse {
    ...
    /** Project name. */
    @Schema(description = "Project name.", example = "TaskFlow Backend")
    ...
    @Schema(description = "Username of the project owner.", example = "mehdi")
