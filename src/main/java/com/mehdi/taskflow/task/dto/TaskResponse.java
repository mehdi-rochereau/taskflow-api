 ...
 *
 * <p>Wraps a {@link Task} entity and exposes only the fields relevant to the API consumer. The full
 * project and assignee entities are replaced by their respective identifiers and usernames.
 *
 * <p>This class is immutable — all fields are final and set once at construction time. No setters
 * are provided.
 *
 * <p>Used as the response body for all task endpoints.
 *
...
public class TaskResponse {
    ...
    /** Task title. */
    @Schema(description = "Task title.", example = "Implement JWT authentication")
    ...
    /** Optional due date. */
    @Schema(description = "Optional due date (ISO 8601 date format).", example = "2026-12-31")
    private final LocalDate dueDate;

    /** Identifier of the project this task belongs to. */
    @Schema(description = "Identifier of the project this task belongs to.", example = "1")
    ...
    @Schema(description = "Timestamp of task creation (ISO 8601).", example = "2026-04-18T10:00:00")
