 ...
 *
 * <ul>
 *   <li>{@code POST /api/projects/{projectId}/tasks} — create a new task
 *   <li>{@code PUT /api/projects/{projectId}/tasks/{id}} — update an existing task
 * </ul>
 *
 * @see com.mehdi.taskflow.task.TaskController
 * @see com.mehdi.taskflow.task.TaskService
 */
@Schema(name = "TaskRequest", description = "Request body for creating or updating a task")
public class TaskRequest {
    ...
    /**
     * Task status. Required — must be one of {@link TaskStatus#TODO}, {@link
     * TaskStatus#IN_PROGRESS}, or {@link TaskStatus#DONE}.
     */
    @Schema(
    ...
    /**
     * Task priority. Required — must be one of {@link TaskPriority#LOW}, {@link
     * TaskPriority#MEDIUM}, or {@link TaskPriority#HIGH}.
     */
    @Schema(
    ...
    /**
     * Optional identifier of the user to assign this task to. If {@code null}, the task remains
     * unassigned. Must reference an existing user — validated by the service layer.
     */
    @Schema(
            description =
                    "Optional ID of the user to assign this task to. Must reference an existing user. If null, the task remains unassigned.",
            example = "2",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED)
